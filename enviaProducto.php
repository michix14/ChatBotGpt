...
*/
function enviarProducto($recibido, $producto, $idWA,$timestamp,$telefonoCliente) {
    require_once './conexion.php';
    //CONSULTAMOS TODOS LOS REGISTROS CON EL ID DEL MENSAJE
    $sqlCantidad = "SELECT count(id) AS cantidad FROM producto WHERE id_wa='" . $idWA . "';";
    ...
    if ($cantidad == 0) {
        ...
        $sql = "INSERT INTO producto "
            . "(mensaje_recibido    ,producto   ,id_wa        ,timestamp_wa        ,     telefono_wa) VALUES "
            . "('" . $recibido . "' ,'" . $producto . "','" . $idWA . "','" . $timestamp . "','" . $telefonoCliente . "');";
        $conn->query($sql);
        $conn->close();
